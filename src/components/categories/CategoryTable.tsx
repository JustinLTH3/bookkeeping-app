      ...
      <table className="w-full table-fixed">
        <thead>
          <tr className="bg-primary text-white">
            <th className="w-[40%] px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">
              Name
            </th>
            <th className="w-[25%] px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">
              Type
            </th>
            <th className="w-[35%] px-6 py-3 text-right text-xs font-medium uppercase tracking-wider">
              Actions
            </th>
          </tr>
        </thead>
